...
import {RanaStableCoin} from "./RanaStableCoin.sol";
...
contract DSCEngine is ReentrancyGuard {
    ...
    // State Variables
    ///////////////////
    RanaStableCoin private immutable i_rana;
    ...
    constructor(address[] memory tokenAddresses, address[] memory priceFeedAddresses, address dscAddress) {
        ...
        i_rana = RanaStableCoin(dscAddress);
    }
    ...
    * @notice: A known bug would be if the protocol was only 100% collateralized, we wouldn't be able to liquidate
    ...
    function _burnDsc(uint256 amountDscToBurn, address onBehalfOf, address dscFrom) private {
        ...
        bool success = i_rana.transferFrom(dscFrom, address(this), amountDscToBurn);
        // This conditional is hypothetically unreachable
        if (!success) {
            revert DSCEngine__TransferFailed();
        }
        i_rana.burn(amountDscToBurn);
    }
